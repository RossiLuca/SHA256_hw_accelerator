...
proc usage {} {
  puts "\
usage: vivado -mode batch -source <script> -tclargs <sha256>
  <sha256>: absolute path of sha256 repository clone
}

if { $argc == 1 } {
  set sha256 [lindex $argv 0]
} else {
  usage
  exit -1
}
...
add_files $sha256/vhdl/axi_pkg.vhd $sha256/sha256/vhdl/sha256_package.vhd $sha256/sha256/vhdl/comp_sha256.vhd \
  $sha256/sha256/vhdl/data_expW.vhd $sha256/sha256/vhdl/sha256_dp.vhd \
  $sha256/sha256/vhdl/sha256_fsm.vhd $sha256/sha256/vhdl/hw_sha256.vhd \
  $sha256/sha256/vhdl/sha256_axi.vhd
